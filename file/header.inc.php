...
<div style="position:relative; top:20px; class="container-fluid">
  <div class="row">
	...
	<div class="col-xs-8" ><img src="img/logo.svg" width="250" height="80" alt="TS3DNS" />
   ...
   <!-- Brand and toggle get grouped for better mobile display -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="index.php?id=demo"><span class="glyphicon glyphicon-eye-open"></span> Demo</a></li>
